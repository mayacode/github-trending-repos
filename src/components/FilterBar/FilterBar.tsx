...
export type FilterBarProps = Pick<UseTrendingReposReturn, 'changePerPage' | 'end' | 'perPage' | 'start'>;

export default function FilterBar({ changePerPage, end, perPage, start }: FilterBarProps) {
  return (
