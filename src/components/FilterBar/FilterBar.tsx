  ...
  return (
    <section className="flex flex-wrap items-center gap-4 px-6 py-4 mb-6 bg-blue-100 dark:bg-gray-800 bg-opacity-80 dark:bg-opacity-80 shadow-md">
      ...
      <input
        ...
        className="rounded border border-blue-200 dark:border-green-700 px-2 py-1 bg-blue-50 dark:bg-green-950 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-green-400 placeholder-gray-600 dark:placeholder-gray-300 caret-gray-900 dark:caret-gray-100"
      />
